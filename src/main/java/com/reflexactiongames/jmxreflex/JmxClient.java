...
public class JmxClient {
	...
	public static String invokeByPid(String pid, String beanName, String methodName, Object[] params, String[] signature)
			throws Exception {
		return invokeByMainClassOrPid(null, pid, beanName, methodName, params, signature);
	}

	public static String invokeByUrl(String url1, String beanName, String methodName, Object[] params,
